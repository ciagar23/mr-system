...
?>	 
  ...
  <tr> 
   ...
   <td class="content"> <input name="txtCode" type="text" class="box" id="txtCode" value="<?php echo $pd_code; ?>" size="50" maxlength="100"></td>
  </tr>
  <tr> 
   <td width="150" class="label">Description</td>
   <td class="content"> <textarea name="mtxDescription" cols="70" rows="5" class="box" id="mtxDescription"><?php echo $pd_description; ?></textarea></td>
  </tr>
  <tr> 
