...
?>
  <tr class="<?php echo $class; ?>"> 
   <td><a href="index.php?view=detail&productId=<?php echo $pd_id; ?>"><?php echo $pd_name; ?> ( <?php echo $pd_code; ?> )</a></td>
   <td width="75" align="center"><img src="<?php echo $pd_thumbnail; ?>"></td>
   <td width="75" align="center"><?php echo $cat_name; ?></td>
   <td width="70" align="center"><a href="javascript:modifyProduct(<?php echo $pd_id; ?>);" class="ico edit">Modify</a></td>
   <td width="70" align="center"><a href="javascript:deleteProduct(<?php echo $pd_id; ?>, <?php echo $catId; ?>);" class="ico del">Delete</a></td>
  </tr>
  <?php
	} // end while
?>
